...
function loadCharts() {
    ...
    function t(e, t) {
        ...
        return a
    }(e = getChartColorsArray("audiences_metrics_charts")) && (e = {
        series: [{
            name: "Last Year",
    ...
    }, "" != audiencesMetricsCharts && audiencesMetricsCharts.destroy(), (audiencesMetricsCharts = new ApexCharts(document.querySelector("#audiences_metrics_charts"), e)).render());
    var r;
    (e = getChartColorsArray("audiences-sessions-country-charts")) && (r = {
        series: [{
            name: "Sat",
            data: t(18, {
                min: 0,
    ...
    }, "" != audiencesSessionsCountryChart && audiencesSessionsCountryChart.destroy(), (audiencesSessionsCountryChart = new ApexCharts(document.querySelector("#audiences-sessions-country-charts"), r)).render());
